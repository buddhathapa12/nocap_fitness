...
const Mental = () => {
  ...
  //     "AIzaSyCqVDOOSbqwM_AS43V_Bmoe239J1h9vahU"
  //   );
  const apiKey: string = "AIzaSyCqVDOOSbqwM_AS43V_Bmoe239J1h9vahU";
   ...
   */
  interface ExpanderSetter {
    (value: boolean): void;
  }

  const toggleExpander = (
    setter: ExpanderSetter,
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-6 shadow-sm">
          <div className="bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800 p-4 rounded-md">
            ...
            <p className="text-sm">
              ...
              thoughts of self-harm or severe crisis:
            </p>
